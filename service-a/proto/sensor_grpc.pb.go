...
const (
	SensorService_SendData_FullMethodName = "/sensor.SensorService/SendData"
)
...
func (c *sensorServiceClient) SendData(ctx context.Context, in *SensorData, opts ...grpc.CallOption) (*Empty, error) {
...
func (UnimplementedSensorServiceServer) SendData(context.Context, *SensorData) (*Empty, error) {
